...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        ...
        double y1 = that.y;
        double slope;
        if (x1 == x0 && y1 == y0) { slope = Double.NEGATIVE_INFINITY; }
        else if (x1 == x0) { slope = Double.POSITIVE_INFINITY; }        
        else if (y1 == y0) { slope = +0.0; }
     ...
     */
    public Comparator<Point> slopeOrder() { return new BySlope(); }
